        ...
        this.canvas.onclick = function () {
            if (value.flag === true) {
                let events = {
                    ...
                    removeTile: () => {//Трябва да се ъпдейтва височината в паметта, не в чънка (за да се запазят промените върху чънка реално)
                    //за да работи по-правилно трябва да се маха ПРОЦЕНТ от височината, не hardcoded число
                        if (value.h - 50 < 0) {
                            value.h = 0
                        } else {
                            value.h -= 50
